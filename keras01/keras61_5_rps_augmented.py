...
x_train = np.load('./_save/_npy/study/keras59_rps_x_train.npy')   
y_train = np.load('./_save/_npy/study/keras59_rps_y_train.npy')    
x_test = np.load('./_save/_npy/study/keras59_rps_x_val.npy')   
y_test = np.load('./_save/_npy/study/keras59_rps_y_val.npy')
...
hist = model.fit(x_train, y_train, epochs=8, batch_size=256, verbose=1, validation_split=0.02)
...
'''
loss =  1.0034151077270508
acc =  0.414682537317276
val_acc =  0.4262295067310333
'''
