...
x_train = np.load('./_save/_npy/study/keras59_HH_x_train.npy')   
y_train = np.load('./_save/_npy/study/keras59_HH_y_train.npy')    
x_test = np.load('./_save/_npy/study/keras59_HH_x_val.npy')   
y_test = np.load('./_save/_npy/study/keras59_HH_y_val.npy')
...
'''
loss =  0.6396409869194031
acc =  0.6878048777580261
val_acc =  0.7027027010917664
'''
