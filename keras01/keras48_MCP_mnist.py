...
#                                         filepath='./_save/MCP/keras48_MCP_mnist.hdf5')
...
model = load_model('./_save/MCP/keras48_MCP_mnist.hdf5')
...
'''
loss =  0.061007726937532425
accuracy =  0.98089998960495
time taken(s) :  15.813844203948975

load_MCP
loss =  0.06809397786855698
