...
##### tensorflow 1
## layer 1
w1 = tf.compat.v1.get_variable('w1', shape=[2, 2, 3, 32])   # [kernel_size, input의 channel(color) 수(맨 마지막), output]
...
## layer 2
w2 = tf.compat.v1.get_variable('w2', shape=[2, 2, 32, 64])
...
## layer 3
w3 = tf.compat.v1.get_variable('w3', shape=[2, 2, 64, 128])
